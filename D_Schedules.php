...
<html lang="en">
	<head>
		...
		<title>Schedules | Bus Booking System</title>
		...
		<form method = "post" action="process_schedules.php">
			<center>
			...
			<input type="date" name="day" id="date" requied><br>

			<span id="errorMessage" class="error-message"></span><br>
			
			<input name="search" type="submit" value="Search Buses" id="search">
			</center>
		</form>
		...
		<div id="container">
			...
			<div class="f_routes_container">
				...
				<button onclick="freq1()">Search Buses</button>
			</div>
			<div class="f_routes_container">
				<span>Galle -<br>Colombo</span>
				<button onclick="freq2()">Search Buses</button>
			</div>
			<div class="f_routes_container">
				<span>Trincomalee -<br>Colombo</span>
				<button onclick="freq3()">Search Buses</button>
			</div>
			<div class="f_routes_container">
				<span>Nuwara Eliya -<br>Galle</span>
				<button onclick="freq4()">Search Buses</button>
			</div>
		</div>
		</main>
